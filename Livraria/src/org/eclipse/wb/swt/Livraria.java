...
public class Livraria {
	...
	Livraria() {
		...
		/**
		 * +++++++++++++++++++++++ Só para efeito de testes, define-se agora uma
		...
		Livro lv1 = new Livro("Hitchhicker's Guide to the Galaxy", "8695477532745", "Douglas Adams", "Leya",
				"Ficção Científica. Viagens espaciais de um inadaptado", new GregorianCalendar(2017, 11, 18), 16.5, 3,
				precos2);
		Livro lv3 = new Livro("Nove Amanhãs", "1549657432745", "Isak Asimov", "Nébula",
				"Ficção Científica. Nove pequenos contos futurísticos", new GregorianCalendar(2018, 11, 12), 25.8, 20,
				precos3);
		Livro lv4 = new Livro("Um homem estranho numa terra estranha", "9635874432745", "Ursula K Leguin", "Nébula",
				"Ficção Científica. Um extra-terrestre chega à terra", new GregorianCalendar(2017, 11, 12), 15.5, 0,
				precos1);
